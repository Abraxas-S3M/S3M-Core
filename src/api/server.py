...
from services.predictive_defense.api_routes import router as predictive_defense_router
...
app.include_router(predictive_defense_router, tags=["Predictive Defense"])
