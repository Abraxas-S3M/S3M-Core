"""S3M interop integration wrapper for open-dis-python."""
...
_CLASS_NAME = "OpenDisPythonAdapter"


def __getattr__(name: str) -> Any:
    """Lazily expose adapter class for hyphenated package path compatibility."""
    if name != _CLASS_NAME:
