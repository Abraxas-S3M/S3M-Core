# Masendor Integration

## Purpose

This adapter wraps the Masendor repository for S3M simulation and war-gaming workflows.
...
- `MasendorAdapter` in `adapter.py`
- Inherits from `packages.integrations.base.IntegrationAdapter`
- Logger namespace: `s3m.integrations.simulation.masendor`
