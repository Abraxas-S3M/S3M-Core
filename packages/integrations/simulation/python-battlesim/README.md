# python-battlesim Integration

## Purpose

This adapter wraps the python-battlesim repository for S3M simulation and war-gaming workflows.
...
- `PythonBattlesimAdapter` in `adapter.py`
- Inherits from `packages.integrations.base.IntegrationAdapter`
- Logger namespace: `s3m.integrations.simulation.python-battlesim`
