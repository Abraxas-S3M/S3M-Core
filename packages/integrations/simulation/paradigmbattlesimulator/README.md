# ParadigmBattleSimulator Integration

## Purpose

This adapter wraps the ParadigmBattleSimulator repository for S3M simulation and war-gaming workflows.
...
- `ParadigmbattlesimulatorAdapter` in `adapter.py`
- Inherits from `packages.integrations.base.IntegrationAdapter`
- Logger namespace: `s3m.integrations.simulation.paradigmbattlesimulator`
