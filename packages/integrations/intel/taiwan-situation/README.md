...
S3M wrapper for the [TaiWan-situation](https://github.com/Pluto114/TaiWan-situation) repository.
...
- Module: `packages.integrations.intel.taiwan-situation.adapter`
- Class: `TaiwanSituationAdapter`
- Integration ID: `taiwan-situation`
- Domain: `intel`
