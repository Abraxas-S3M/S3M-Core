...
This adapter wraps the `prosody` repository for secure communications workflows in S3M.
...
- `ProsodyAdapter` in `adapter.py`
- Inherits from `packages.integrations.base.IntegrationAdapter`
- Logger namespace: `s3m.integrations.comms.prosody`
