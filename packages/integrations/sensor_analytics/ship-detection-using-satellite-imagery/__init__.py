"""S3M sensor analytics integration wrapper for optical ship detection imagery."""
...
_CLASS_NAME = "ShipDetectionUsingSatelliteAdapter"


def __getattr__(name: str) -> Any:
    """Lazily expose the adapter class for hyphenated package paths."""
    if name != _CLASS_NAME:
