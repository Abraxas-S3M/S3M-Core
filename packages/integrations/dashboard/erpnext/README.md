...
This wrapper provides a sovereign S3M dashboard integration for **ERPNext**.
...
- Online mode remains local-only and validates runtime availability via `bench or erpnext`.
