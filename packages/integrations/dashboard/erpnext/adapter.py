"""Dashboard integration adapter for ERPNext."""
...
class ErpnextAdapter(IntegrationAdapter):
    ...
    def __init__(self, mode: str | None = None) -> None:
        ...
        self.logger = logging.getLogger("s3m.integrations.dashboard.erpnext")
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            name=str(raw_manifest.get("name") or "ERPNext"),
            slug=str(raw_manifest.get("slug") or self.integration_id),
            domain=str(raw_manifest.get("domain") or self.domain),
            source_url=str(raw_manifest.get("source_url") or "https://github.com/frappe/erpnext"),
            license=str(raw_manifest.get("license") or "GPL-3.0"),
            description="ERP dashboard adapter for procurement, inventory, and budget controls in tactical sustainment workflows.",
    ...
    def validate_availability(self) -> bool:
        ...
        runtime_candidates = ["bench", "erpnext"]
