"""Dashboard integration adapter for Actual."""
...
class ActualAdapter(IntegrationAdapter):
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            name=str(raw_manifest.get("name") or "Actual"),
            slug=str(raw_manifest.get("slug") or self.integration_id),
            domain=str(raw_manifest.get("domain") or self.domain),
            source_url=str(raw_manifest.get("source_url") or "https://github.com/actualbudget/actual"),
            license=str(raw_manifest.get("license") or "MIT"),
            description="Budget-tracking dashboard adapter for procurement visibility during sustained operations.",
            integration_type="adapter",
            capabilities=[
    "budget_monitoring",
    "procurement_visualization",
    ...
    def validate_availability(self) -> bool:
        ...
        runtime_candidates = ["actual-server", "node"]
