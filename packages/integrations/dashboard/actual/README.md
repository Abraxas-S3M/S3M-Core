...
This wrapper provides a sovereign S3M dashboard integration for **Actual**.
...
- Online mode remains local-only and validates runtime availability via `actual-server or node`.
