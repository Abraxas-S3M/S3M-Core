"""Dashboard integration wrapper for Awesome-Threat-Detection (Curated).

Military/tactical context:
This adapter standardizes telemetry exchange so mission operators can query
Awesome-Threat-Detection (Curated) workflows through a uniform S3M interface in contested, airgapped
...
class AwesomeThreatDetectioncuratedAdapter(IntegrationAdapter):
    """Adapter for tactical dashboard ingestion and status checks."""

    integration_id = "awesome-threat-detection-curated"
    domain = "dashboard"

    _repo_env_var = "AWESOME_THREAT_DETECTION_CURATED_PATH"
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            ...
            description=str(raw.get("description") or "Curated tactical dashboard references for threat hunting workflows, including Suricata-oriented interfaces."),
