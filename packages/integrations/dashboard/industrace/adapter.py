"""Dashboard integration wrapper for Industrace.

Military/tactical context:
This adapter standardizes telemetry exchange so mission operators can query
Industrace workflows through a uniform S3M interface in contested, airgapped
...
class IndustraceAdapter(IntegrationAdapter):
    """Adapter for tactical dashboard ingestion and status checks."""

    integration_id = "industrace"
    domain = "dashboard"

    _repo_env_var = "INDUSTRACE_PATH"
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            ...
            description=str(raw.get("description") or "ICS/OT asset exposure dashboard wrapper for mission-critical industrial sites and operational technology enclaves."),
