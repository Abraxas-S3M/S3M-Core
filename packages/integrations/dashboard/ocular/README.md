...
This wrapper provides a sovereign S3M dashboard integration for **Ocular**.
...
- Online mode remains local-only and validates runtime availability via `ocular or node`.
