"""Dashboard integration adapter for Ocular."""
...
class OcularAdapter(IntegrationAdapter):
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            name=str(raw_manifest.get("name") or "Ocular"),
            slug=str(raw_manifest.get("slug") or self.integration_id),
            domain=str(raw_manifest.get("domain") or self.domain),
            source_url=str(raw_manifest.get("source_url") or "https://github.com/simonwep/ocular"),
            license=str(raw_manifest.get("license") or "MIT"),
            description="Financial dashboard adapter with chart and Sankey style budget flow summaries for mission command.",
            integration_type="adapter",
            capabilities=[
    "budget_flow_analysis",
    "charting",
    "sankey_overview",
            ],
    ...
    def validate_availability(self) -> bool:
        ...
        runtime_candidates = ["ocular", "node"]
