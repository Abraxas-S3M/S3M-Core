"""Dashboard integration wrapper for RogueShield AI Threat Detector.

Military/tactical context:
This adapter standardizes telemetry exchange so mission operators can query
RogueShield AI Threat Detector workflows through a uniform S3M interface in contested, airgapped
...
class RogueshieldAiThreatDetectorAdapter(IntegrationAdapter):
    """Adapter for tactical dashboard ingestion and status checks."""

    integration_id = "rogueshield-ai-threat-detector"
    domain = "dashboard"

    _repo_env_var = "ROGUESHIELD_AI_THREAT_DETECTOR_PATH"
    _fallback_binary = "python3"
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            ...
            description=str(raw.get("description") or "AI-driven threat dashboard wrapper with forecast confidence and explainability signals for tactical defenders."),
