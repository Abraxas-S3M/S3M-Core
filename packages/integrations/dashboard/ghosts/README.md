...
This wrapper provides a sovereign S3M dashboard integration for **GHOSTS**.
...
- Online mode remains local-only and validates runtime availability via `dotnet or docker`.
