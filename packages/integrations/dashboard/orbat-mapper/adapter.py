"""Dashboard integration wrapper for Orbat-Mapper.

Military/tactical context:
This adapter standardizes telemetry exchange so mission operators can query
Orbat-Mapper workflows through a uniform S3M interface in contested, airgapped
...
class OrbatMapperAdapter(IntegrationAdapter):
    ...
    _repo_env_var = "ORBAT_MAPPER_PATH"
    _fallback_binary = "node"
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            ...
            description=str(raw.get("description") or "ORBAT and unit plotting dashboard integration for situational awareness of friendly and opposing formations."),
