"""Adapter for ROS2-NMPC-ACADOS navigation integration.
...
class Ros2NmpcAcadosAdapter(IntegrationAdapter):
    """S3M adapter for ros2-nmpc-acados."""

    integration_id = "ros2-nmpc-acados"
    domain = "navigation"
    ...
    _MODULE_CANDIDATES = ('acados_template', 'rclpy')
    _COMMAND_CANDIDATES = ('ros2', 'colcon', 'acados')
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            name=str(raw.get("name", "ROS2-NMPC-ACADOS")),
    ...
    def execute(self, params: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        request = params or {}
        operation = str(request.get("operation", "trajectory_tracking")).strip().lower()
        ...
        if not self.validate_availability():
            return {
                ...
                "operation": operation,
                "request": request,
                "message": "ROS2-NMPC-ACADOS dependencies are not installed or configured.",
            }
        ...
        return {
            ...
            "operation": operation,
            "request": request,
            "message": "Local NMPC prerequisites validated; mission runtime should invoke ROS2 nodes directly.",
        }
