# Mobile-Swarm-Navigation Integration

## Purpose

This adapter wraps `mobile-swarm-navigation` for S3M swarm mission orchestration with deterministic,
...
- `MobileSwarmNavigationAdapter` in `adapter.py`
- Inherits from `packages.integrations.base.IntegrationAdapter`
- Logger namespace: `s3m.integrations.swarm.mobile-swarm-navigation`
