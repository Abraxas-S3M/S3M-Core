...
class MispAdapter(IntegrationAdapter):
    """Thin wrapper for MISP cyber-defense workflows."""
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            ...
            description=str(raw.get("description") or "Threat intelligence exchange adapter for sovereign sharing and enrichment of hostile indicators."),
    ...
    def validate_availability(self) -> bool:
        ...
        return bool(
            any(shutil.which(tool) for tool in ("misp-modules", "misp"))
        or bool(self._env("MISP_URL") and self._env("MISP_API_KEY"))
        or Path("/var/www/MISP").exists()
        )
    ...
    def execute(self, params: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        action = str(request.get("action") or "search_events")
        return {
            "status": "accepted",
            "mode": "online",
            "integration_id": self.integration_id,
