...
class CortexAdapter(IntegrationAdapter):
    """Thin wrapper for Cortex cyber-defense workflows."""
    ...
    def get_manifest(self) -> IntegrationManifest:
        ...
        return IntegrationManifest(
            ...
            description=str(raw.get("description") or "Observable analysis and active response adapter for tactical cyber threat analysis workflows."),
    ...
    def validate_availability(self) -> bool:
        ...
        return bool(
            any(shutil.which(tool) for tool in ("cortex", "cortex-analyzer"))
        or bool(self._env("CORTEX_URL"))
        or Path("/etc/cortex/application.conf").exists()
        )
    ...
    def execute(self, params: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        action = str(request.get("action") or "run_analyzer")
        return {
            "status": "accepted",
            "mode": "online",
            "integration_id": self.integration_id,
